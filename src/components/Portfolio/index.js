...
function Portfolio() {
  ...
  const [projects] = useState([
    ...
    },
    {
      ...
      description: 'Text editor w/ local installation available as a progressive web app',
    ...
    },
    {
      ...
      description: 'Short and sweet READme generator that runs in the command line',
